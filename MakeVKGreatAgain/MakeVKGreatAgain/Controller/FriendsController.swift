...
class FriendsController: UITableViewController {
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        return isSearchActive ? 1 : 1 //sections.count
    }

    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return isSearchActive ? displayData.count : displayData.count //sections[section].count
    }
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if isSearchActive{
            ...
            let name = displayData[indexPath.row].name //sections[indexPath.section][indexPath.row].name
